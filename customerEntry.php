 <?php
	...
	if(array_key_exists("submit", $_POST))
	{
		...
		else
		{
			...
			{
				$query = "SELECT * FROM `customer` WHERE `email` = '".mysqli_real_escape_string($link, $_POST['email'])."' AND PASSWORD='".mysqli_real_escape_string($link, $_POST['password'])."'";
				$result=mysqli_query($link,$query);
...
<?php include("header.php"); ?>
	<div class="container">
		...
		<fieldset class="form-group">
			...
			<input type="submit" class="btn btn-lg btn-success ToggleForm" name="submit" value="Log in!">
		</fieldset>
